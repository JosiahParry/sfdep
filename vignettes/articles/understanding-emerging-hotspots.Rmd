...
In this vignette we walk through the Gettis-Ord Gi\*, the Mann-Kendall, and how the two work together to in EHSA. 
...
> Note: 2022-05-31 this data is avaiable only in the development version, so please install with `remotes::install_github("josiahparry/sfdep")`.
