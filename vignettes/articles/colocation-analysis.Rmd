...
Note that for the first observation we only have a CLQ for `C` and `E`. This is because the neighborhood of the first observatino consists of only C and E values. We can verify this like so. 
